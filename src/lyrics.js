...
const lyrics = [
  { time: 11.00,   text: `Svima kažeš „ne“,` },
  { time: 15.10,   text: `jer lakše je tako, znam.` },
  { time: 18.00,  text: `Ono što nije bio ni početak,` },
  { time: 21.00,  text: `tvojim je potezom postao kraj.` },

  { time: 24.00,  text: `Znam da nisam tvoj svijet,` },
  { time: 27.50,  text: `al’ neću samo proći kraj.` },
  { time: 31.16,  text: `Oko tebe leden zid od tajni,` },
  { time: 34.00,  text: `a ja bih samo tvoj topli zagrljaj.` },

  { time: 39.00,  text: `Jedan iskren i stvaran.` },

  { time: 45.00,  text: `Hoćeš li mi pokazati tajni svijet ispod maske?` },
  { time: 53.00,  text: `Hoćeš li pustiti da te sloboda dotakne?` },
  { time: 59.00,  text: `Zaslužuješ osmijeh iskren i pravi,` },
  { time: 62.00,  text: `Skini sve što skrivaš,` },
  { time: 65.00,  text: `Želim znati ` },
  { time: 69.00,  text: `Tko si ispod svega, tko si stvarna ti.` },
  ...
  { time: 195.00, text: `Ispod smijeha, ispod šutnje – ona stvarna ti?` },
  { time: 202.00, text: `Skini sve što te dijeli,` },
  { time: 204.00, text: `Pokaži mi gdje boli,` },
  { time: 207.00, text: `Želim znat’ ` },
  { time: 211.00, text: `Tko si ona stvarna ti.` },

  { time: 227.00, text: `(Ona stvarna ti.)` },
];
